...
<form action="../Controlador/index_usuarios.php" method="POST" enctype="multipart/form-data">
    ...
    <input type="text" name="tit" value="<?php if(isset($_GET["tit"])) echo $_GET["tit"] ?>"><br>
    <label for="plat">Plataforma</label><br>
    <input type="text" name="plat" value="<?php if(isset($_GET["plat"])) echo $_GET["plat"] ?>"><br>
    <label for="lanz">Año de lanzamiento</label><br>
    <input type="number" name="lanz" value="<?php if(isset($_GET["lanz"])) echo $_GET["lanz"] ?>"><br>
    <label for="img">Imagen:</label><br>
    <input type="file" name="img" value="<?php if(isset($_GET["img"])) echo $_GET["img"] ?>"><br>
